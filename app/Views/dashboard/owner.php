...
<body class="hold-transition sidebar-mini">
                    ...
                    <div class="col-12">
                        <div class="card" id="owner_Table">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <table id="table_owner" class="table table-hover">
                                            <thead>
                                                <tr>
                                                    <th>ลำดับ</th>
                                                    <th>ชื่อ - นามสกุล</th>
    ...
    <script>
        function load_modal(load_check, data_encode) {
            ...
            if (load_check == 1) {
                ...
                $(".modal-body #url_route").val("dashboard/owner/edit/" + rowData.id_user);
            }
        }
    </script>
    <script>
    ...
    <script>
        function getTableData() {
            if ($.fn.DataTable.isDataTable('#table_owner')) {
                $('#table_owner').DataTable().destroy();
            }
            $('#table_owner').DataTable({
                "processing": $("#owner_Table .overlay").show(),
                "pageLength": 10,
                "pagingType": "full_numbers", // Display pagination as 1, 2, 3... instead of Previous, Next buttons
                'serverSide': true,
                'ajax': {
                    'url': "<?php echo site_url('dashboard/owner/getdata/2'); ?>",
                    'type': 'GET',
                    'dataSrc': 'data',
                },
                "responsive": true,
                ...
                "drawCallback": function (settings) {
                    $("#owner_Table .overlay").hide();
                    var daData = settings.json.data;
                    if (daData.length == 0) {
                        $('#table_owner tbody').html(`
                        <tr>
